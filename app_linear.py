...
# sidebar para selação de variáveis
with st.sidebar:
...
with col2:
    ...
    for category, variables in var_categories.items():
        # mostrar apenas variáveis que existem no df
...
with tab1:
    if len(x_cols) == 1:
        ...
        # em vez disso matriz de correlação para múltiplas variáveis
...
if st.checkbox("Mostrar exemplo de cálculo manual"):
    ...
    sample_idx = 0 # Pegar primeira linha como exemplo
